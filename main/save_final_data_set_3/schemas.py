...
class OKXDataSetRecordDataOld2(Base):
    __tablename__ = 'okx_data_set_record_data_old_2'
...
class OKXDataSetRecordData_3(Base):
    __tablename__ = 'okx_data_set_record_data_3'
