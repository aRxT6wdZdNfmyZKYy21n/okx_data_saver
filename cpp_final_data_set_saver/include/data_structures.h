...
struct OKXDataSetRecordData {
    ...
    OKXDataSetRecordData(SymbolId symbol_id, 
        ...
        , buy_quantity(utils::Decimal(static_cast<int64_t>(0)))
        , buy_trades_count(0)
        , buy_volume(utils::Decimal(static_cast<int64_t>(0)))
        , close_price(utils::Decimal(static_cast<int64_t>(0)))
        , end_asks_total_quantity(utils::Decimal(static_cast<int64_t>(0)))
        , end_asks_total_volume(utils::Decimal(static_cast<int64_t>(0)))
        , max_end_ask_price(utils::Decimal(static_cast<int64_t>(0)))
        , max_end_ask_quantity(utils::Decimal(static_cast<int64_t>(0)))
        , max_end_ask_volume(utils::Decimal(static_cast<int64_t>(0)))
        , min_end_ask_price(utils::Decimal(static_cast<int64_t>(0)))
        , min_end_ask_quantity(utils::Decimal(static_cast<int64_t>(0)))
        , min_end_ask_volume(utils::Decimal(static_cast<int64_t>(0)))
        , end_bids_total_quantity(utils::Decimal(static_cast<int64_t>(0)))
        , end_bids_total_volume(utils::Decimal(static_cast<int64_t>(0)))
        , max_end_bid_price(utils::Decimal(static_cast<int64_t>(0)))
        , max_end_bid_quantity(utils::Decimal(static_cast<int64_t>(0)))
        , max_end_bid_volume(utils::Decimal(static_cast<int64_t>(0)))
        , min_end_bid_price(utils::Decimal(static_cast<int64_t>(0)))
        , min_end_bid_quantity(utils::Decimal(static_cast<int64_t>(0)))
        , min_end_bid_volume(utils::Decimal(static_cast<int64_t>(0)))
        , end_timestamp_ms(0)
        , end_trade_id(0)
        , high_price(utils::Decimal(static_cast<int64_t>(0)))
        , start_asks_total_quantity(utils::Decimal(static_cast<int64_t>(0)))
        , start_asks_total_volume(utils::Decimal(static_cast<int64_t>(0)))
        , max_start_ask_price(utils::Decimal(static_cast<int64_t>(0)))
        , max_start_ask_quantity(utils::Decimal(static_cast<int64_t>(0)))
        , max_start_ask_volume(utils::Decimal(static_cast<int64_t>(0)))
        , min_start_ask_price(utils::Decimal(static_cast<int64_t>(0)))
        , min_start_ask_quantity(utils::Decimal(static_cast<int64_t>(0)))
        , min_start_ask_volume(utils::Decimal(static_cast<int64_t>(0)))
        , start_bids_total_quantity(utils::Decimal(static_cast<int64_t>(0)))
        , start_bids_total_volume(utils::Decimal(static_cast<int64_t>(0)))
        , max_start_bid_price(utils::Decimal(static_cast<int64_t>(0)))
        , max_start_bid_quantity(utils::Decimal(static_cast<int64_t>(0)))
        , max_start_bid_volume(utils::Decimal(static_cast<int64_t>(0)))
        , min_start_bid_price(utils::Decimal(static_cast<int64_t>(0)))
        , min_start_bid_quantity(utils::Decimal(static_cast<int64_t>(0)))
        , min_start_bid_volume(utils::Decimal(static_cast<int64_t>(0)))
        , low_price(utils::Decimal(static_cast<int64_t>(0)))
        , open_price(utils::Decimal(static_cast<int64_t>(0)))
        , start_timestamp_ms(0)
        , start_trade_id(0)
        , total_quantity(utils::Decimal(static_cast<int64_t>(0)))
        , total_trades_count(0)
        , total_volume(utils::Decimal(static_cast<int64_t>(0))) {}
};
