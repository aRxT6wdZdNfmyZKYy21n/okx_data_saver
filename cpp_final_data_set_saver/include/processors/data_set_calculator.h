...
public:
    ...
    struct TradeStatistics {
        ...
        std::optional<utils::Decimal> close_price;
        std::optional<utils::Decimal> high_price;
        std::optional<utils::Decimal> low_price;
        std::optional<utils::Decimal> open_price;
        std::optional<int64_t> start_trade_id;
        std::optional<int64_t> end_trade_id;
