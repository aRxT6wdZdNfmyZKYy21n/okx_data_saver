...
class CppDataProcessorIntegration:
    ...
    def __init__(self, enable_cpp: bool = True):
        ...
        if self.enable_cpp:
            ...
            logger.warning(
                'C++ Data Processor not available, falling back to Python implementation'
            )

    def process_trades_data(
        self, symbol_id: SymbolId, trades_df: DataFrame
    ) -> dict[str, Any]:
        """
    ...
    def process_trades_data_async(
        self, symbol_id: SymbolId, trades_df: DataFrame, callback: callable
    ) -> None:
        """
        ...
        try:
            ...
            self.cpp_processor.process_trades_data_async(
                symbol_id, cpp_trades_df, cpp_callback
            )
...
def process_trades_with_cpp(
    symbol_id: SymbolId, trades_df: DataFrame
) -> dict[str, Any]:
    """
...
def process_trades_with_cpp_async(
    symbol_id: SymbolId, trades_df: DataFrame, callback: callable
) -> None:
    """
